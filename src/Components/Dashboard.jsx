  ...
  return (
    <div className='w-screen h-screen px-5  '>
      ...
      <div className='relative'>
         <div className='pt-10 '>
         <h4 className='text-[blue] font-medium text-base '> Thu 6 feb</h4>
      ...
      <div className='w-full max-h-[70%] rounded-lg py-5  overflow-y-auto flex flex-wrap justify-start  gap-2 '> 

          {
            taskarray.map((Task ,index)=>{return(
              <div key={index} className=' px-5 py-3  mt-3 w-40 h-25 backdrop-blur-xs bg-transparent active:bg-blue-400  shadow-xl rounded-lg  '>
        ...
        <button className=  'px-5 py-3  mt-3 w-40 h-25 bg-transparent backdrop-blur-xs  shadow-xl rounded-lg flex justify-center items-center'>
         <GoPlus className='text-zinc-400  h-16 w-16 '/>
        </button>
      </div>
      </div>
    <div className='absolute bg-[url(https://img.freepik.com/free-vector/completed-concept-illustration_114360-2945.jpg?t=st=1741605177~exp=1741608777~hmac=9f54cfd5354477b611a5fcfd668776ca2d3a256fa68fc8879b441f5e129ebfb3&w=900)] bg-cover opacity-80  w-full h-screen bg-no-repeat bg-center top-0 left-0 z-[-1]  '>
